...
UCLASS()
class DCOM2_API ACarDir : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(EditAnywhere) TArray<FChangeCameraData> Cameras;
	int32 NowCameraIndex;

	//UPROPERTY(EditAnywhere) AActor* CameraOne;
	//UPROPERTY(EditAnywhere) AActor* CameraTwo;
	UPROPERTY(EditAnywhere) float TimeToNextCameraChange;
