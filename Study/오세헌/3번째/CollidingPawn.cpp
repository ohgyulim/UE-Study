...
ACollidingPawn::ACollidingPawn()
{
	...
	if (SphereVisualAsset.Succeeded()) {
		SphereVisual->SetupAttachment(RootComponent);
		SphereVisual->bAutoActivate = false;
		SphereVisual->SetRelativeLocation(FVector(-20.0f, 0.0f, 20.0f));
		static ConstructorHelpers::FObjectFinder<UParticleSystem> ParticleAsset(TEXT("/Game/StarterContnet/Particles/P_Fire.P_Fire"));
...
void ACollidingPawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	InputComponent->BindAxis("MoveTurn", this, &ACollidingPawn::Turn);
